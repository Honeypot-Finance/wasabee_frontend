  ...
  return (
    <NumericFormat
      ...
      classNames={{
        ...
        inputWrapper:
          "bg-white border h-[64px] border-black text-black px-4 data-[hover=true]:bg-white group-data-[focus=true]:bg-white group-data-[invalid=true]:border-[#D53F3F] shadow-[0px_332px_93px_0px_rgba(0,0,0,0.00),0px_212px_85px_0px_rgba(0,0,0,0.01),0px_119px_72px_0px_rgba(0,0,0,0.05),0px_53px_53px_0px_rgba(0,0,0,0.09),0px_13px_29px_0px_rgba(0,0,0,0.10)]",
