...
export type Pot2Pump_Filter = {
  ...
  LaunchTokenPriceChange24hPercentage?: InputMaybe<
    Scalars["BigDecimal"]["input"]
  >;
  LaunchTokenPriceChange24hPercentage_gt?: InputMaybe<
    Scalars["BigDecimal"]["input"]
  >;
  LaunchTokenPriceChange24hPercentage_gte?: InputMaybe<
    Scalars["BigDecimal"]["input"]
  >;
  LaunchTokenPriceChange24hPercentage_in?: InputMaybe<
    Array<Scalars["BigDecimal"]["input"]>
  >;
  LaunchTokenPriceChange24hPercentage_lt?: InputMaybe<
    Scalars["BigDecimal"]["input"]
  >;
  LaunchTokenPriceChange24hPercentage_lte?: InputMaybe<
    Scalars["BigDecimal"]["input"]
  >;
  LaunchTokenPriceChange24hPercentage_not?: InputMaybe<
    Scalars["BigDecimal"]["input"]
  >;
  LaunchTokenPriceChange24hPercentage_not_in?: InputMaybe<
    Array<Scalars["BigDecimal"]["input"]>
  >;
  ...
  LaunchTokenPriceChange24h_in?: InputMaybe<
    Array<Scalars["BigDecimal"]["input"]>
  >;
  ...
  LaunchTokenPriceChange24h_not_in?: InputMaybe<
    Array<Scalars["BigDecimal"]["input"]>
  >;
  ...
  depositRaisedTokenPercentageToMinCap?: InputMaybe<
    Scalars["BigDecimal"]["input"]
  >;
  depositRaisedTokenPercentageToMinCap_gt?: InputMaybe<
    Scalars["BigDecimal"]["input"]
  >;
  depositRaisedTokenPercentageToMinCap_gte?: InputMaybe<
    Scalars["BigDecimal"]["input"]
  >;
  depositRaisedTokenPercentageToMinCap_in?: InputMaybe<
    Array<Scalars["BigDecimal"]["input"]>
  >;
  depositRaisedTokenPercentageToMinCap_lt?: InputMaybe<
    Scalars["BigDecimal"]["input"]
  >;
  depositRaisedTokenPercentageToMinCap_lte?: InputMaybe<
    Scalars["BigDecimal"]["input"]
  >;
  depositRaisedTokenPercentageToMinCap_not?: InputMaybe<
    Scalars["BigDecimal"]["input"]
  >;
  depositRaisedTokenPercentageToMinCap_not_in?: InputMaybe<
    Array<Scalars["BigDecimal"]["input"]>
  >;
...
export type Token_Filter = {
  ...
  priceChange24hPercentage_in?: InputMaybe<
    Array<Scalars["BigDecimal"]["input"]>
  >;
  ...
  priceChange24hPercentage_not_in?: InputMaybe<
    Array<Scalars["BigDecimal"]["input"]>
  >;
...
export type AccountPot2PumpFieldFragment = {
  __typename?: "Pot2Pump";
  id: string;
};
...
export type DexAccountCountQuery = {
  __typename?: "Query";
  factories: Array<{ __typename?: "Factory"; id: string; accountCount: any }>;
};
...
export type PoolHourDataFieldsFragment = {
  __typename?: "PoolHourData";
  feesUSD: any;
  id: string;
  tvlUSD: any;
...
export type PoolWeekDataFieldsFragment = {
  __typename?: "PoolWeekData";
  feesUSD: any;
  tvlUSD: any;
  volumeUSD: any;
...
export type PoolMonthDataFieldsFragment = {
  __typename?: "PoolMonthData";
  feesUSD: any;
  tvlUSD: any;
  volumeUSD: any;
...
export type LiquidatorDataQuery = {
  __typename?: "Query";
  liquidatorDatas: Array<{
    __typename?: "LiquidatorData";
    id: string;
...
export type LiquidatorDataFieldsFragment = {
  __typename?: "LiquidatorData";
  id: string;
  totalLiquidityUsd: any;
  pool: {
...
export type UserActivePositionsQuery = {
  __typename?: "Query";
  positions: Array<{
    __typename?: "Position";
    owner: any;
...
export type GetParticipantDetailQuery = {
  __typename?: "Query";
  participants: Array<{
    __typename?: "Participant";
    id: string;
...
export type Pot2PumpPottingNearSuccessQuery = {
  __typename?: "Query";
  pot2Pumps: Array<{
    __typename?: "Pot2Pump";
    id: string;
...
export type Pot2PumpPottingHighPriceQueryVariables = Exact<{
  [key: string]: never;
}>;

export type Pot2PumpPottingHighPriceQuery = {
  __typename?: "Query";
  pot2Pumps: Array<{
    __typename?: "Pot2Pump";
    id: string;
...
export type Pot2PumpFieldFragment = {
  __typename?: "Pot2Pump";
  id: string;
  launchTokenInitialPrice: any;
  DepositLaunchToken: any;
...
export type ParticipantTransactionHistoryFieldsFragment = {
  __typename?: "ParticipantTransactionHistory";
  id: string;
};
...
export type CanRefundPot2PumpParticipantQuery = {
  __typename?: "Query";
  participants: Array<{
    __typename?: "Participant";
    id: string;
...
export type TransactionFieldsFragment = {
  ...
  mints: Array<{ __typename?: "Mint"; id: string }>;
  burns: Array<{ __typename?: "Burn"; id: string }>;
  swaps: Array<{
    __typename?: "Swap";
    id: string;
    timestamp: any;
  ...
  flashed: Array<{ __typename?: "Flash"; id: string }>;
  collects: Array<{ __typename?: "Collect"; id: string }>;
  depositRaisedTokens: Array<{
    __typename?: "DepositRaisedToken";
    id: string;
    timestamp: any;
    amount: any;
...
export type SwapFieldsFragment = {
  __typename?: "Swap";
  id: string;
  timestamp: any;
  sender: any;
...
export type DepositRaisedTokenFieldsFragment = {
  __typename?: "DepositRaisedToken";
  id: string;
  timestamp: any;
  amount: any;
...
export type RefundFieldsFragment = {
  __typename?: "Refund";
  id: string;
  timestamp: any;
  amount: any;
...
export type ClaimLpFieldsFragment = {
  __typename?: "ClaimLp";
  id: string;
  timestamp: any;
  amount: any;
...
export type DepositRaisedTokenQuery = {
  __typename?: "Query";
  depositRaisedTokens: Array<{
    __typename?: "DepositRaisedToken";
    id: string;
...
export type FlashesQuery = {
  __typename?: "Query";
  flashes: Array<{ __typename?: "Flash"; id: string }>;
};
 ...
 * });
 */
export function useDexAccountCountQuery(
  baseOptions?: Apollo.QueryHookOptions<
    DexAccountCountQuery,
    DexAccountCountQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<DexAccountCountQuery, DexAccountCountQueryVariables>(
    DexAccountCountDocument,
    options
  );
}
export function useDexAccountCountLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    DexAccountCountQuery,
    DexAccountCountQueryVariables
  >
  ...
  return Apollo.useLazyQuery<
    DexAccountCountQuery,
    DexAccountCountQueryVariables
  >(DexAccountCountDocument, options);
}
export function useDexAccountCountSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<
        DexAccountCountQuery,
...
export type DexAccountCountQueryHookResult = ReturnType<
  typeof useDexAccountCountQuery
>;
export type DexAccountCountLazyQueryHookResult = ReturnType<
  typeof useDexAccountCountLazyQuery
>;
export type DexAccountCountSuspenseQueryHookResult = ReturnType<
  typeof useDexAccountCountSuspenseQuery
>;
export type DexAccountCountQueryResult = Apollo.QueryResult<
  DexAccountCountQuery,
  DexAccountCountQueryVariables
>;
 ...
 * });
 */
export function useLiquidatorDataQuery(
  baseOptions: Apollo.QueryHookOptions<
    LiquidatorDataQuery,
    LiquidatorDataQueryVariables
  > &
    (
      | { variables: LiquidatorDataQueryVariables; skip?: boolean }
      | { skip: boolean }
    )
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<LiquidatorDataQuery, LiquidatorDataQueryVariables>(
    LiquidatorDataDocument,
    options
  );
}
export function useLiquidatorDataLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    LiquidatorDataQuery,
    LiquidatorDataQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<LiquidatorDataQuery, LiquidatorDataQueryVariables>(
    LiquidatorDataDocument,
    options
  );
}
export function useLiquidatorDataSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<
        LiquidatorDataQuery,
  ...
  return Apollo.useSuspenseQuery<
    LiquidatorDataQuery,
    LiquidatorDataQueryVariables
  >(LiquidatorDataDocument, options);
}
export type LiquidatorDataQueryHookResult = ReturnType<
  typeof useLiquidatorDataQuery
>;
export type LiquidatorDataLazyQueryHookResult = ReturnType<
  typeof useLiquidatorDataLazyQuery
>;
export type LiquidatorDataSuspenseQueryHookResult = ReturnType<
  typeof useLiquidatorDataSuspenseQuery
>;
export type LiquidatorDataQueryResult = Apollo.QueryResult<
  LiquidatorDataQuery,
  LiquidatorDataQueryVariables
>;
...
export function useUserPositionsQuery(
  baseOptions: Apollo.QueryHookOptions<
    UserPositionsQuery,
    UserPositionsQueryVariables
  > &
    (
      | { variables: UserPositionsQueryVariables; skip?: boolean }
      | { skip: boolean }
    )
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<UserPositionsQuery, UserPositionsQueryVariables>(
    UserPositionsDocument,
    options
  );
}
export function useUserPositionsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    UserPositionsQuery,
    UserPositionsQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<UserPositionsQuery, UserPositionsQueryVariables>(
    UserPositionsDocument,
    options
  );
}
export function useUserPositionsSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<
        UserPositionsQuery,
  ...
  return Apollo.useSuspenseQuery<
    UserPositionsQuery,
    UserPositionsQueryVariables
  >(UserPositionsDocument, options);
}
export type UserPositionsQueryHookResult = ReturnType<
  typeof useUserPositionsQuery
>;
export type UserPositionsLazyQueryHookResult = ReturnType<
  typeof useUserPositionsLazyQuery
>;
export type UserPositionsSuspenseQueryHookResult = ReturnType<
  typeof useUserPositionsSuspenseQuery
>;
export type UserPositionsQueryResult = Apollo.QueryResult<
  UserPositionsQuery,
  UserPositionsQueryVariables
>;
 ...
 * });
 */
export function useUserActivePositionsQuery(
  baseOptions: Apollo.QueryHookOptions<
    UserActivePositionsQuery,
    UserActivePositionsQueryVariables
  > &
    (
      | { variables: UserActivePositionsQueryVariables; skip?: boolean }
      | { skip: boolean }
    )
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    UserActivePositionsQuery,
    UserActivePositionsQueryVariables
  >(UserActivePositionsDocument, options);
}
export function useUserActivePositionsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    UserActivePositionsQuery,
    UserActivePositionsQueryVariables
  >
...
export function useUserActivePositionsSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<
        UserActivePositionsQuery,
...
export type UserActivePositionsQueryHookResult = ReturnType<
  typeof useUserActivePositionsQuery
>;
export type UserActivePositionsLazyQueryHookResult = ReturnType<
  typeof useUserActivePositionsLazyQuery
>;
export type UserActivePositionsSuspenseQueryHookResult = ReturnType<
  typeof useUserActivePositionsSuspenseQuery
>;
export type UserActivePositionsQueryResult = Apollo.QueryResult<
  UserActivePositionsQuery,
  UserActivePositionsQueryVariables
>;
 ...
 * });
 */
export function useGetPot2PumpDetailQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetPot2PumpDetailQuery,
    GetPot2PumpDetailQueryVariables
  > &
    (
      | { variables: GetPot2PumpDetailQueryVariables; skip?: boolean }
      | { skip: boolean }
    )
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    GetPot2PumpDetailQuery,
    GetPot2PumpDetailQueryVariables
  >(GetPot2PumpDetailDocument, options);
}
export function useGetPot2PumpDetailLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetPot2PumpDetailQuery,
    GetPot2PumpDetailQueryVariables
  >
...
export function useGetPot2PumpDetailSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<
        GetPot2PumpDetailQuery,
...
export type GetPot2PumpDetailQueryHookResult = ReturnType<
  typeof useGetPot2PumpDetailQuery
>;
export type GetPot2PumpDetailLazyQueryHookResult = ReturnType<
  typeof useGetPot2PumpDetailLazyQuery
>;
export type GetPot2PumpDetailSuspenseQueryHookResult = ReturnType<
  typeof useGetPot2PumpDetailSuspenseQuery
>;
export type GetPot2PumpDetailQueryResult = Apollo.QueryResult<
  GetPot2PumpDetailQuery,
  GetPot2PumpDetailQueryVariables
>;
 ...
 * });
 */
export function useGetParticipantDetailQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetParticipantDetailQuery,
    GetParticipantDetailQueryVariables
  > &
    (
      | { variables: GetParticipantDetailQueryVariables; skip?: boolean }
      | { skip: boolean }
    )
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    GetParticipantDetailQuery,
    GetParticipantDetailQueryVariables
  >(GetParticipantDetailDocument, options);
}
export function useGetParticipantDetailLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetParticipantDetailQuery,
    GetParticipantDetailQueryVariables
  >
...
export function useGetParticipantDetailSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<
        GetParticipantDetailQuery,
...
export type GetParticipantDetailQueryHookResult = ReturnType<
  typeof useGetParticipantDetailQuery
>;
export type GetParticipantDetailLazyQueryHookResult = ReturnType<
  typeof useGetParticipantDetailLazyQuery
>;
export type GetParticipantDetailSuspenseQueryHookResult = ReturnType<
  typeof useGetParticipantDetailSuspenseQuery
>;
export type GetParticipantDetailQueryResult = Apollo.QueryResult<
  GetParticipantDetailQuery,
  GetParticipantDetailQueryVariables
>;
 ...
 * });
 */
export function usePot2PumpPottingNewTokensQuery(
  baseOptions?: Apollo.QueryHookOptions<
    Pot2PumpPottingNewTokensQuery,
    Pot2PumpPottingNewTokensQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    Pot2PumpPottingNewTokensQuery,
    Pot2PumpPottingNewTokensQueryVariables
  >(Pot2PumpPottingNewTokensDocument, options);
}
export function usePot2PumpPottingNewTokensLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    Pot2PumpPottingNewTokensQuery,
    Pot2PumpPottingNewTokensQueryVariables
  >
...
export function usePot2PumpPottingNewTokensSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<
        Pot2PumpPottingNewTokensQuery,
...
export type Pot2PumpPottingNewTokensQueryHookResult = ReturnType<
  typeof usePot2PumpPottingNewTokensQuery
>;
export type Pot2PumpPottingNewTokensLazyQueryHookResult = ReturnType<
  typeof usePot2PumpPottingNewTokensLazyQuery
>;
export type Pot2PumpPottingNewTokensSuspenseQueryHookResult = ReturnType<
  typeof usePot2PumpPottingNewTokensSuspenseQuery
>;
export type Pot2PumpPottingNewTokensQueryResult = Apollo.QueryResult<
  Pot2PumpPottingNewTokensQuery,
  Pot2PumpPottingNewTokensQueryVariables
>;
 ...
 * });
 */
export function usePot2PumpPottingNearSuccessQuery(
  baseOptions?: Apollo.QueryHookOptions<
    Pot2PumpPottingNearSuccessQuery,
    Pot2PumpPottingNearSuccessQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    Pot2PumpPottingNearSuccessQuery,
    Pot2PumpPottingNearSuccessQueryVariables
  >(Pot2PumpPottingNearSuccessDocument, options);
}
export function usePot2PumpPottingNearSuccessLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    Pot2PumpPottingNearSuccessQuery,
    Pot2PumpPottingNearSuccessQueryVariables
  >
...
export type Pot2PumpPottingNearSuccessQueryHookResult = ReturnType<
  typeof usePot2PumpPottingNearSuccessQuery
>;
export type Pot2PumpPottingNearSuccessLazyQueryHookResult = ReturnType<
  typeof usePot2PumpPottingNearSuccessLazyQuery
>;
export type Pot2PumpPottingNearSuccessSuspenseQueryHookResult = ReturnType<
  typeof usePot2PumpPottingNearSuccessSuspenseQuery
>;
export type Pot2PumpPottingNearSuccessQueryResult = Apollo.QueryResult<
  Pot2PumpPottingNearSuccessQuery,
  Pot2PumpPottingNearSuccessQueryVariables
>;
 ...
 * });
 */
export function usePot2PumpPottingHighPriceQuery(
  baseOptions?: Apollo.QueryHookOptions<
  ...
  return Apollo.useQuery<
    Pot2PumpPottingHighPriceQuery,
    Pot2PumpPottingHighPriceQueryVariables
  >(Pot2PumpPottingHighPriceDocument, options);
}
export function usePot2PumpPottingHighPriceLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    Pot2PumpPottingHighPriceQuery,
    Pot2PumpPottingHighPriceQueryVariables
  >
...
export function usePot2PumpPottingHighPriceSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<
        Pot2PumpPottingHighPriceQuery,
...
export type Pot2PumpPottingHighPriceQueryHookResult = ReturnType<
  typeof usePot2PumpPottingHighPriceQuery
>;
export type Pot2PumpPottingHighPriceLazyQueryHookResult = ReturnType<
  typeof usePot2PumpPottingHighPriceLazyQuery
>;
export type Pot2PumpPottingHighPriceSuspenseQueryHookResult = ReturnType<
  typeof usePot2PumpPottingHighPriceSuspenseQuery
>;
 ...
 * });
 */
export function useCanClaimPot2PumpParticipantQuery(
  baseOptions: Apollo.QueryHookOptions<
    CanClaimPot2PumpParticipantQuery,
    CanClaimPot2PumpParticipantQueryVariables
  > &
    (
      | { variables: CanClaimPot2PumpParticipantQueryVariables; skip?: boolean }
      | { skip: boolean }
    )
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    CanClaimPot2PumpParticipantQuery,
    CanClaimPot2PumpParticipantQueryVariables
  >(CanClaimPot2PumpParticipantDocument, options);
}
export function useCanClaimPot2PumpParticipantLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    CanClaimPot2PumpParticipantQuery,
    CanClaimPot2PumpParticipantQueryVariables
  >
...
export function useCanClaimPot2PumpParticipantSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<
        CanClaimPot2PumpParticipantQuery,
...
export type CanClaimPot2PumpParticipantQueryHookResult = ReturnType<
  typeof useCanClaimPot2PumpParticipantQuery
>;
export type CanClaimPot2PumpParticipantLazyQueryHookResult = ReturnType<
  typeof useCanClaimPot2PumpParticipantLazyQuery
>;
export type CanClaimPot2PumpParticipantSuspenseQueryHookResult = ReturnType<
  typeof useCanClaimPot2PumpParticipantSuspenseQuery
>;
export type CanClaimPot2PumpParticipantQueryResult = Apollo.QueryResult<
  CanClaimPot2PumpParticipantQuery,
  CanClaimPot2PumpParticipantQueryVariables
>;
 ...
 * });
 */
export function useCanRefundPot2PumpParticipantQuery(
  baseOptions: Apollo.QueryHookOptions<
  ...
  > &
    (
      | {
          variables: CanRefundPot2PumpParticipantQueryVariables;
          skip?: boolean;
        }
      | { skip: boolean }
    )
  ...
  return Apollo.useQuery<
    CanRefundPot2PumpParticipantQuery,
    CanRefundPot2PumpParticipantQueryVariables
  >(CanRefundPot2PumpParticipantDocument, options);
}
export function useCanRefundPot2PumpParticipantLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    CanRefundPot2PumpParticipantQuery,
    CanRefundPot2PumpParticipantQueryVariables
  >
...
export function useCanRefundPot2PumpParticipantSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<
        CanRefundPot2PumpParticipantQuery,
...
export type CanRefundPot2PumpParticipantQueryHookResult = ReturnType<
  typeof useCanRefundPot2PumpParticipantQuery
>;
export type CanRefundPot2PumpParticipantLazyQueryHookResult = ReturnType<
  typeof useCanRefundPot2PumpParticipantLazyQuery
>;
export type CanRefundPot2PumpParticipantSuspenseQueryHookResult = ReturnType<
  typeof useCanRefundPot2PumpParticipantSuspenseQuery
>;
export type CanRefundPot2PumpParticipantQueryResult = Apollo.QueryResult<
  CanRefundPot2PumpParticipantQuery,
  CanRefundPot2PumpParticipantQueryVariables
>;
...
export function useSwapsQuery(
  baseOptions?: Apollo.QueryHookOptions<SwapsQuery, SwapsQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<SwapsQuery, SwapsQueryVariables>(
    SwapsDocument,
    options
  );
}
export function useSwapsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<SwapsQuery, SwapsQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<SwapsQuery, SwapsQueryVariables>(
    SwapsDocument,
    options
  );
}
export function useSwapsSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<SwapsQuery, SwapsQueryVariables>
) {
  const options =
    baseOptions === Apollo.skipToken
      ? baseOptions
      : { ...defaultOptions, ...baseOptions };
  return Apollo.useSuspenseQuery<SwapsQuery, SwapsQueryVariables>(
    SwapsDocument,
    options
  );
}
...
export type SwapsSuspenseQueryHookResult = ReturnType<
  typeof useSwapsSuspenseQuery
>;
export type SwapsQueryResult = Apollo.QueryResult<
  SwapsQuery,
  SwapsQueryVariables
>;
 ...
 * });
 */
export function useDepositRaisedTokenQuery(
  baseOptions?: Apollo.QueryHookOptions<
    DepositRaisedTokenQuery,
    DepositRaisedTokenQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    DepositRaisedTokenQuery,
    DepositRaisedTokenQueryVariables
  >(DepositRaisedTokenDocument, options);
}
export function useDepositRaisedTokenLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    DepositRaisedTokenQuery,
    DepositRaisedTokenQueryVariables
  >
...
export function useDepositRaisedTokenSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<
        DepositRaisedTokenQuery,
...
export type DepositRaisedTokenQueryHookResult = ReturnType<
  typeof useDepositRaisedTokenQuery
>;
export type DepositRaisedTokenLazyQueryHookResult = ReturnType<
  typeof useDepositRaisedTokenLazyQuery
>;
export type DepositRaisedTokenSuspenseQueryHookResult = ReturnType<
  typeof useDepositRaisedTokenSuspenseQuery
>;
export type DepositRaisedTokenQueryResult = Apollo.QueryResult<
  DepositRaisedTokenQuery,
  DepositRaisedTokenQueryVariables
>;
 ...
 * });
 */
export function useRefundQuery(
  baseOptions?: Apollo.QueryHookOptions<RefundQuery, RefundQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<RefundQuery, RefundQueryVariables>(
    RefundDocument,
    options
  );
}
export function useRefundLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<RefundQuery, RefundQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<RefundQuery, RefundQueryVariables>(
    RefundDocument,
    options
  );
}
export function useRefundSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<RefundQuery, RefundQueryVariables>
) {
  const options =
    baseOptions === Apollo.skipToken
      ? baseOptions
      : { ...defaultOptions, ...baseOptions };
  return Apollo.useSuspenseQuery<RefundQuery, RefundQueryVariables>(
    RefundDocument,
    options
  );
}
...
export type RefundSuspenseQueryHookResult = ReturnType<
  typeof useRefundSuspenseQuery
>;
export type RefundQueryResult = Apollo.QueryResult<
  RefundQuery,
 ...
 * });
 */
export function useClaimLpQuery(
  baseOptions?: Apollo.QueryHookOptions<ClaimLpQuery, ClaimLpQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<ClaimLpQuery, ClaimLpQueryVariables>(
    ClaimLpDocument,
    options
  );
}
export function useClaimLpLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<ClaimLpQuery, ClaimLpQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<ClaimLpQuery, ClaimLpQueryVariables>(
    ClaimLpDocument,
    options
  );
}
export function useClaimLpSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<ClaimLpQuery, ClaimLpQueryVariables>
) {
  const options =
    baseOptions === Apollo.skipToken
      ? baseOptions
      : { ...defaultOptions, ...baseOptions };
  return Apollo.useSuspenseQuery<ClaimLpQuery, ClaimLpQueryVariables>(
    ClaimLpDocument,
    options
  );
}
...
export type ClaimLpSuspenseQueryHookResult = ReturnType<
  typeof useClaimLpSuspenseQuery
>;
export type ClaimLpQueryResult = Apollo.QueryResult<
  ClaimLpQuery,
  ClaimLpQueryVariables
>;
 ...
 * });
 */
export function useFlashesQuery(
  baseOptions?: Apollo.QueryHookOptions<FlashesQuery, FlashesQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<FlashesQuery, FlashesQueryVariables>(
    FlashesDocument,
    options
  );
}
export function useFlashesLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<FlashesQuery, FlashesQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<FlashesQuery, FlashesQueryVariables>(
    FlashesDocument,
    options
  );
}
export function useFlashesSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<FlashesQuery, FlashesQueryVariables>
) {
  const options =
    baseOptions === Apollo.skipToken
      ? baseOptions
      : { ...defaultOptions, ...baseOptions };
  return Apollo.useSuspenseQuery<FlashesQuery, FlashesQueryVariables>(
    FlashesDocument,
    options
  );
}
...
export type FlashesSuspenseQueryHookResult = ReturnType<
  typeof useFlashesSuspenseQuery
>;
export type FlashesQueryResult = Apollo.QueryResult<
  FlashesQuery,
  FlashesQueryVariables
>;
 ...
 * });
 */
export function useCollectQuery(
  baseOptions?: Apollo.QueryHookOptions<CollectQuery, CollectQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<CollectQuery, CollectQueryVariables>(
    CollectDocument,
    options
  );
}
export function useCollectLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<CollectQuery, CollectQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<CollectQuery, CollectQueryVariables>(
    CollectDocument,
    options
  );
}
export function useCollectSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<CollectQuery, CollectQueryVariables>
) {
  const options =
    baseOptions === Apollo.skipToken
      ? baseOptions
      : { ...defaultOptions, ...baseOptions };
  return Apollo.useSuspenseQuery<CollectQuery, CollectQueryVariables>(
    CollectDocument,
    options
  );
}
...
export type CollectSuspenseQueryHookResult = ReturnType<
  typeof useCollectSuspenseQuery
>;
export type CollectQueryResult = Apollo.QueryResult<
  CollectQuery,
 ...
 * });
 */
export function useBurnQuery(
  baseOptions?: Apollo.QueryHookOptions<BurnQuery, BurnQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<BurnQuery, BurnQueryVariables>(BurnDocument, options);
}
export function useBurnLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<BurnQuery, BurnQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<BurnQuery, BurnQueryVariables>(
    BurnDocument,
    options
  );
}
export function useBurnSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<BurnQuery, BurnQueryVariables>
) {
  const options =
    baseOptions === Apollo.skipToken
      ? baseOptions
      : { ...defaultOptions, ...baseOptions };
  return Apollo.useSuspenseQuery<BurnQuery, BurnQueryVariables>(
    BurnDocument,
    options
  );
}
...
export type BurnSuspenseQueryHookResult = ReturnType<
  typeof useBurnSuspenseQuery
>;
...
export function useMintQuery(
  baseOptions?: Apollo.QueryHookOptions<MintQuery, MintQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<MintQuery, MintQueryVariables>(MintDocument, options);
}
export function useMintLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<MintQuery, MintQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<MintQuery, MintQueryVariables>(
    MintDocument,
    options
  );
}
export function useMintSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<MintQuery, MintQueryVariables>
) {
  const options =
    baseOptions === Apollo.skipToken
      ? baseOptions
      : { ...defaultOptions, ...baseOptions };
  return Apollo.useSuspenseQuery<MintQuery, MintQueryVariables>(
    MintDocument,
    options
  );
}
...
export type MintSuspenseQueryHookResult = ReturnType<
  typeof useMintSuspenseQuery
>;
